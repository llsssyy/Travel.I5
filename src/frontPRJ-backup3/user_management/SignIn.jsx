    ...
    return(
        ...
        <div className="sign_in_bg">
            <div id="sign_in_wrap">
                ...
                <input type="text" name="uId" value={uId} onChange={uIdChangeHandler} spellCheck="false" autoFocus placeholder="아이디를 적으세요" />
                </div>
                
                <div className="menu_sign_in">
                <label htmlFor="id">비밀번호</label>
                <input type="password" name="uPw" value={uPw} onChange={uPwChangeHandler} spellCheck="false" placeholder="비밀번호를 입력하세요" />
                </div>
                
                <button className="sign_in_btn" onClick={signInBtnClickHandler} >로그인</button>
            </div>
        </div>
        </>
    );
