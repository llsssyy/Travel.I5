    ...
    <div className="sign_up_bg">
        <div id="wrap_sign_up">
            <div className="menu_sign_up">
                ...
                <input type="text" name="uId" value={uId} onChange={uIdChangeHandler} spellCheck="false" autoFocus placeholder="4-10사이 대소문자 또는 숫자만 입력해 주세요!" />
                <p className="message" style={{ color: !isId ? 'red' : 'green' }}> {idMessage}</p>
                <div className="dupliBtn">
            ...
            <div className="menu_sign_up">
                ...
                <input type="password" name="dupliPw" value={dupliPw} onChange={dupliPwChangeHandler} spellCheck="false" placeholder="비밀번호를 다시 입력해주세요."/>
                <p className="message" style={{ color: !isDupliPassword ? 'red' : 'green'}}> {dupliPwMessage} </p>
            </div>
            
            <div className="menu_sign_up">
                <label htmlFor="mail">메일 주소</label>
                <input type="email" name="uMail" value={uMail} onChange={uMailChangeHandler} spellCheck="false" placeholder="이메일을 입력하세요." />
                <p className="message" style={{ color: !isMail ? 'red' : 'green' }}> {mailMessage} </p>
            </div>
            
            <div className="menu_sign_up">
                <label htmlFor="phone">전화번호</label>
                <input type="text" name="uPhone" value={uPhone} onChange={uPhoneChangeHandeler} spellCheck="false" placeholder="전화번호를 입력하세요." />
