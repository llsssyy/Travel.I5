        ...
        <div className="modify_bg">
            <div id="wrap_modify">
                ...
                <div className="rmenu_modify">
                    ...
                    <input type="email" name="rMail" value={rMail} onChange={rMailChangeHandler} spellCheck="false" placeholder="이메일 입력" />
                    <p className="message" style={{color: !isMail ? 'red' : 'green' }}> {mailMessage} </p>
                </div>
                <br />
                <div className="rmenu_modify">
                    <label htmlFor="phone">전화번호</label>
                    <input type="text" name="rPhone" value={rPhone} onChange={rPhoneChangeHandler} spellCheck="false" placeholder="번호 입력" />
