            ...
            return (
              <div
                style={{
                  ...
                  backgroundColor: i === currentSlide ? '#5a5a5a' : '#fff', // 선택된 도트의 색상을 변경
                }}
              ></div>
            );
          },
                ...
                <Slider {...settings}>
                    ...
                    <div className="local_item" id="seoul_01">
                        <a href="#none" onClick={() => localItemClickHandler("seoul_01")}>
                            <img className="local_seoul_01" src="./resources/frontPRJ/imgs/pic01.png" />
                    ...
                    <div className="local_item" id="seoul_02">
                        <a href="#none" onClick={() => localItemClickHandler("seoul_02")}>
                            <img className="local_seoul_02" src="./resources/frontPRJ/imgs/pic02.png" />
                    ...
                    <div className="local_item" id="incheon">
                        <a href="#none" onClick={() => localItemClickHandler("incheon")}>
                            <img className="local_incheon" src="./resources/frontPRJ/imgs/pic03.png" />
                    ...
                    <div className="local_item" id="daejeon">
                        <a href="#none" onClick={() => localItemClickHandler("daejeon")}>
                            <img className="local_daejeon" src="./resources/frontPRJ/imgs/pic04.png" />
                    ...
                    <div className="local_item" id="daegu">
                        <a href="#none" onClick={() => localItemClickHandler("daegu")}>
                            <img className="local_daegu" src="./resources/frontPRJ/imgs/pic05.png" />
                    ...
                    <div className="local_item" id="gyeonggi">
                        <a href="#none" onClick={() => localItemClickHandler("gyeonggi")}>
                            <img className="local_gyeonggi" src="./resources/frontPRJ/imgs/pic06.png" />
                    ...
                    <div className="local_item" id="busan">
                        <a href="#none" onClick={() => localItemClickHandler("busan")}>
                            <img className="local_busan" src="./resources/frontPRJ/imgs/pic07.png" />
                    ...
                    <div className="local_item" id="ulsan">
                        <a href="#none" onClick={() => localItemClickHandler("ulsan")}>
                            <img className="local_ulsan" src="./resources/frontPRJ/imgs/pic08.png" />
                    ...
                    <div className="local_item" id="gwangju">
                        <a href="#none" onClick={() => localItemClickHandler("gwangju")}>
                            <img className="local_gwangju" src="./resources/frontPRJ/imgs/pic09.png" />
                    ...
                    <div className="local_item" id="gangwon">
                        <a href="#none" onClick={() => localItemClickHandler("gangwon")}>
                            <img className="local_gangwon" src="./resources/frontPRJ/imgs/pic010.png" />
...
const CustomPrevArrow = (props) => {        // 캐러셀 화살표 커스텀부분(좌)
    const { onClick } = props;
    return (
        <img src="./resources/frontPRJ/imgs/left_arrow.png" id="leftArw" onClick={onClick} />
    );
};
...
const CustomNextArrow = (props) => {        // 캐러셀 화살표 커스텀부분(우)
    const { onClick } = props;
    return (
        <img src="./resources/frontPRJ/imgs/right_arrow.png" id="rightArw" onClick={onClick} />
    );
};
