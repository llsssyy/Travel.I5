...
const Local = () => {
    ...
    const modalBgClickHandler = () => {                     // 모달창 닫는 버튼 (close)
    ...
    const localClickHandler = (localNo) => {            // 지역 범례 버튼 클릭 핸들러
        ...
        switch (localNo) {
            case "all":
                setShowLocal("all");
                break;
            case "seoul,gyeonggi,incheon":
                setShowLocal("seoul,gyeonggi,incheon");
                break;
            case "gangwon-do":
    ...
    let dummyLocalDB = {
        ["seoul_01"]: {
            local: "seoul_01",
            name: "서울_01",
            info: "마포 문화비축기지 / 서울특별시 마포구 / 반려동물과 함께 거닐어보는 친환경과 재생의 아이콘 \n\
        ...
        ["seoul_02"]: {
            local: "seoul_02",
            name: "서울_02",
            info: "예술의전당 한가람미술관 / 서울특별시 서초구 / 예술의 풍경을 담는 전시공간 \n\
        ...
        ["incheon"]: {
            local: "incheon",
            name: "인천",
            info: "송도 한옥마을 / 인천 연수구 / 가장 현대적인 도시속 전통적인 한옥을 즐길 수 있는 곳 \n\
        ...
        ["daejeon"]: {
            local: "daejeon",
            name: "대전",
            info: "봉명동 우산거리 / 대전 유성구 \n\
            봉명동 우산 거리는 대전시 유성구 봉명동에 자리 잡고 있다. 거리 초입에 들어서면 건물 사이 공중에 형형색색의 우산이 설치되어 있으며 \n\
        ...
        ["daegu"]: {
            local: "daegu",
            name: "대구",
            info: "혜원의 집 (영화 리틀포레스트 촬영지) / 대구 군위군 / 시골 감성이 주는 힐링을 몸소 느끼다 \n\
        ...
        ["gyeonggi"]: {
            local: "gyeonggi",
            name: "경기",
            info: "수종사 / 경기 남양주시 / 높은 곳에서 두물머리를 바라 볼 수 있는 사찰 \n\
        ...
        ["busan"]: {
            local: "busan",
            name: "부산",
            info: "다대포해수욕장 / 부산 사하구 / 오랜 풍화작용으로 희고 부드러운 모래가 특징인 다대포해수욕장 \n\
        ...
        ["ulsan"]: {
            local: "ulsan",
            name: "울산",
            info: "당사해양낚시공원 / 울산 북구 / 낚시를 좋아하는 사람이라면 한 번쯤 꼭 와봐야 할 곳 \n\
        ...
        ["gwangju"]: {
            local: "gwangju",
            name: "광주",
            info: "김대중컨벤션센터 / 광주 서구 / 국제 교류의 장으로서 지역 역량 강화를 위해 설립한 첨단전시공간 \n\
        ...
        ["gangwon"]: {
            local: "gangwon",
            name: "강원",
            info: "화암동굴 (강원고생대 국가지질공원) / 강원 정선군 / 금광산과 석회석 자연동굴이 어우러진 세계 유일의 동굴 \n\
    ...
    let dummyLocalDBStr = JSON.stringify(dummyLocalDB);
    localStorage.setItem("dummyLocalDB", dummyLocalDBStr);
    ...
    return (
        <div className="local_wrap">
            ...
            {/* 지역 선택 버튼 */}
            <input type="button" onClick={() => localClickHandler("all")} value="전체" />
            <input type="button" onClick={() => localClickHandler("seoul,gyeonggi,incheon")} value="서울,경기,인천" />
            <input type="button" onClick={() => localClickHandler("gangwon-do")} value="강원도" />
            <input type="button" onClick={() => localClickHandler("chungcheongnam-do")} value="충청남도" />
            <input type="button" onClick={() => localClickHandler("gyeongsangbuk-do")} value="경상북도" />
            <input type="button" onClick={() => localClickHandler("gyeongsangnam-do")} value="경상남도" />
            <input type="button" onClick={() => localClickHandler("jeollanam-do")} value="전라남도" />
            <br />
                ...
                <Slider {...settings}>
                    ...
                    <div className="local_item" id="seoul_01">
                        <a href="#none" onClick={() => localItemClickHandler("seoul_01")}>
                            <img className="Local_seoul_01" src="./resorces/frontPRJ/imgs/pic01.png" />
                            <div className="title"><span>마포 문화비축기지</span><br />서울특별시 마포구</div>
                        </a>
                    </div>

                    <div className="local_item" id="seoul_02">
                        <a href="#none" onClick={() => localItemClickHandler("seoul_02")}>
                            <img className="Local_seoul_02" src="./resorces/frontPRJ/imgs/pic02.png" />
                            <div className="title"><span>예술의전당 한가람미술관</span><br />서울특별시 서초구</div>
                        </a>
                    </div>

                    <div className="local_item" id="incheon">
                        <a href="#none" onClick={() => localItemClickHandler("incheon")}>
                            <img className="Local_incheon" src="./resorces/frontPRJ/imgs/pic03.png" />
                            <div className="title"><span>송도 한옥마을</span><br />인천 연수구</div>
                        </a>
                    </div>

                    <div className="local_item" id="daejeon">
                        <a href="#none" onClick={() => localItemClickHandler("daejeon")}>
                            <img className="Local_daejeon" src="./resorces/frontPRJ/imgs/pic04.png" />
                            <div className="title"><span>봉명동 우산거리</span><br />대전 유성구</div>
                        </a>
                    </div>

                    <div className="local_item" id="daegu">
                        <a href="#none" onClick={() => localItemClickHandler("daegu")}>
                            <img className="Local_daegu" src="./resorces/frontPRJ/imgs/pic05.png" />
                            <div className="title"><span>혜원의 집 (영화 리틀포레스트 촬영지)</span><br />대구 군위군</div>
                        </a>
                    </div>

                    <div className="local_item" id="gyeonggi">
                        <a href="#none" onClick={() => localItemClickHandler("gyeonggi")}>
                            <img className="Local_gyeonggi" src="./resorces/frontPRJ/imgs/pic06.png" />
                            <div className="title"><span>수종사</span><br />경기 남양주시</div>
                        </a>
                    </div>

                    <div className="local_item" id="busan">
                        <a href="#none" onClick={() => localItemClickHandler("busan")}>
                            <img className="Local_busan" src="./resorces/frontPRJ/imgs/pic07.png" />
                            <div className="title"><span>다대포해수욕장</span><br />부산 사하구</div>
                        </a>
                    </div>

                    <div className="local_item" id="ulsan">
                        <a href="#none" onClick={() => localItemClickHandler("ulsan")}>
                            <img className="Local_ulsan" src="./resorces/frontPRJ/imgs/pic08.png" />
                            <div className="title"><span>당사해양낚시공원</span><br />울산 북구</div>
                        </a>
                    </div>

                    <div className="local_item" id="gwangju">
                        <a href="#none" onClick={() => localItemClickHandler("gwangju")}>
                            <img className="Local_gwangju" src="./resorces/frontPRJ/imgs/pic09.png" />
                            <div className="title"><span>김대중컨벤션센터</span><br />광주 서구</div>
                        </a>
                    </div>

                    <div className="local_item" id="gangwon">
                        <a href="#none" onClick={() => localItemClickHandler("gangwon")}>
                            <img className="Local_gangwon" src="./resorces/frontPRJ/imgs/pic010.png" />
                            <div className="title"><span>화암동굴 (강원고생대 국가지질공원)</span><br />강원 정선군</div>
                        </a>
                    </div>
...

            {
                showModal
                    ...
                    <div className="modal_bg">
                        ...
                        <div className="modal">
                            <a href="#none">
                                <div className="text">'이곳에 모달 내용을 입력하세요.'</div>                       {/* div 안에 모달창 내용 입력하기 */}
                            </a>
                            <br />
                            <a className="close" href="#none" onClick={modalBgClickHandler}>CLOSE</a>
                        </div>
                    </div>
                    :
                    null
...
const CustomPrevArrow = (props) => {        // 캐러셀 화살표 커스텀부분(좌)
    const { onClick } = props;
    return (
        <img src="./resorces/frontPRJ/imgs/left_arrow.png" id="leftArw" onClick={onClick} />
    );
};
...
const CustomNextArrow = (props) => {        // 캐러셀 화살표 커스텀부분(우)
    const { onClick } = props;
    return (
        <img src="./resorces/frontPRJ/imgs/right_arrow.png" id="rightArw" onClick={onClick} />
    );
};
