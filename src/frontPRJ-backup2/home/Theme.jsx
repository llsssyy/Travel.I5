        ...
        <div id="theme_wrap">
            <div className="theme_wrap_class">
                ...
                <div className="theme_select_bar">
                    ...
                    <button onClick={() => handleCategorySelect('snow')}>Snow</button>
                    <button onClick={() => handleCategorySelect('beach')}>Beach</button>
                    <button onClick={() => handleCategorySelect('forest')}>Forest</button>
                    <button onClick={() => handleCategorySelect('activity')}>Activity</button>
                </div>
                    ...
                    <Slider style={sliderStyle} {...setting} className="img_slide">
                        ...
                        {filteredImages.map((image) => (
                            ...
                            <div key={image.id} className="thum">
                                {/* 이미지의 id값을 전달 */}
                                <a href="#none" onClick={() => themeModalthumsClickHandler(image)}>
                                    {/* 이미지 소스의 경로 */}
                                    <img src={image.src} />
                                    {/* 이미지의 내용 */}
