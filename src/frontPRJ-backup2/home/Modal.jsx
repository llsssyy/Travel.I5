...
const Modal = (props) =>{
    ...
    const commentModifyBtnHandler = (e, uid, index, comment) => {    //댓글 옆의 수정 버튼이 눌렸을 때
        ...
        console.log("selectCommentIdx", selectCommentIdx);
    ...
    const modalBackHandler = (e) => {       //모달 밖의 검은 영역을 클릭 했을때
    ...
    return(
        <div onClick={(e) => modalBackHandler(e) } className="modal" ref={modalBodyRef}>
                ...
                <div>
                    ...
                    <div className="comment">
                        <div className="commentBox">
                            <textarea name="commentArea" cols="100" rows="5" value={uComment} onChange={txtAreaHandler}></textarea>
                                ...
                                > 
                                    {
                                        index === selectCommentIdx ?
                                        <>
                                            <textarea name="modifyArea" cols="100" rows="5" value={uModify} onChange={txtModifyHandler}></textarea>
